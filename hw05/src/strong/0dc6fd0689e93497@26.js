...
function _simple2(d3,simple,drag,url_list,invalidation)
{
  // 指定圖表的尺寸。
  const width = 2000
    ;
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["simple(分數版).json", {url: new URL("./files/76ad2eb169126cccd6aea3a9c92248d56315b9c46d0702406704d57ed2147295000d245706a76537eaa8897919afb62f90067513f69f58ae81a949f490a68c75.json", import.meta.url), mimeType: "application/json", toString}]
  ]);
  main.builtin("FileAttachment", runtime.fileAttachments(name => fileAttachments.get(name)));
  main.variable(observer()).define(["md"], _1);
  main.variable(observer("simple")).define("simple", ["FileAttachment"], _simple);
  main.variable(observer("simple2")).define("simple2", ["d3","simple","drag","url_list","invalidation"], _simple2);
